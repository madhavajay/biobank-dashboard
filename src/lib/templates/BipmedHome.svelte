...
<section class="mb-8 grid gap-6 lg:grid-cols-[1.1fr_1fr] lg:items-center">
	<div class="relative overflow-hidden rounded-[var(--radius)] border p-6 sm:p-9">
		...
		<div class="relative">
			...
			<a href="/?results=1" class="brand-gradient mt-5 inline-block cursor-pointer rounded-md px-4 py-2 text-sm font-semibold text-white shadow-sm">Explorar variantes</a>
		</div>
	</div>
